...
- **Profile widening, still open (M).** Modeling limits the audit cannot
  ...
  Hindi, Welsh, Georgian, Zulu, Xhosa, Nahuatl, Hungarian, Persian, Ancient Greek, Spanish, Arabic, Vietnamese, Swahili, Bengali, Mongolian, Khmer, Nama, Sumerian, Navajo, Arawakan done):
